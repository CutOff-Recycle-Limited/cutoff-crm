-- ============================================================
-- Customer Command Center shared Neon/PostgreSQL schema v2
-- Safe to re-run against the shared database.
-- ============================================================

CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- CRM owns only these tables. Users and canonical tasks are owned by
-- ops-platform in the shared database.
